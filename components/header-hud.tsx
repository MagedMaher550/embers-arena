...
export function HeaderHUD() {
  ...
  const emberPercentage = Math.min((userProfile.embers / (userProfile.level * 100)) * 100, 100)
        ...
        <div className="flex items-center justify-between gap-4">
          ...
          <div className="flex items-center gap-3 md:gap-4 min-w-0">
            <Link href="/realm" className="flex items-center gap-2 shrink-0">
              ...
              <span className="hidden sm:block font-bold text-lg">EMBER ARENA</span>
            </Link>
          ...
          <div className="flex items-center gap-2 md:gap-4 flex-1 max-w-xs">
            <div className="flex-1 min-w-0">
              <div className="flex items-center gap-2 mb-1">
                ...
                <span className="text-sm font-bold">{userProfile.embers}</span>
              </div>
            ...
            {userProfile.streakDays > 0 && (
              <div className="hidden sm:flex items-center gap-1 px-2 py-1 bg-primary/20 rounded-lg shrink-0">
                ...
                <span className="text-xs font-bold">{userProfile.streakDays}d</span>
              </div>
            )}
          </div>
          ...
          <div className="flex items-center justify-between">
            ...
            {userProfile.streakDays > 0 && (
              <div className="flex items-center gap-1 px-2 py-1 bg-primary/20 rounded-lg">
                <Flame className="w-3 h-3 text-primary" />
                <span className="text-xs font-bold">{userProfile.streakDays} day streak</span>
              </div>
            )}
          </div>
        </div>
